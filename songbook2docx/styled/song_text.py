...
from songbook2docx.utils.style_manager import StyleManager, SONG_TEXT
...
class SongText(StyledCell):
    ...
    def add_runs_to_paragraph(self, par: Paragraph, style_manager: StyleManager) -> list[Run]:
        ...
        text_style = style_manager.get_style(SONG_TEXT)
        for r in self.runs:
            run = par.add_run(r[0][indents:], text_style)
